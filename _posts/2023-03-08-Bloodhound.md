...
![Upgraded AD](assets/img/upgraded-ad-badblood.png)
...
![Bloodhound](assets/img/bloodhound-login.png)
...
![Meterpreter](assets/img/meterpreter-listener.png)
...
![SharpHound](assets/img/running-SharpHound.png)
...
![Example path](assets/img/bloodhound-path-to-da-longest-path.png)
Let's see how this looks in AD to get an idea of the path that Bloodhound has identified.
![AD Comparison](assets/img/ad-comparison.png)
...
![EA](assets/img/effective-access.png)
...
![Abuse Info](assets/img/bloodhound-help.png)
...
![AD](assets/img/ad-event-5156.png)
...
![VT](assets/img/powersploit-updated-hash.png)
